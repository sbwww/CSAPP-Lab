...
0000000000401eb4 <launch>:
  ...
  401efc:	be b4 32 40 00       	mov    $0x4032b4,%esi   ; Type string:
  ...
  401f41:	bf cc 32 40 00       	mov    $0x4032cc,%edi   ; Normal return
